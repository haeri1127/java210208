 ...
 * static을 사용하는 갓은 반칙이다.(생성자 공부가 안된다.)
...
public class SalaryMgrView {
	...
	public SalaryMgrView() {
		smEvent = new SalaryMgrHandler(this); /////대체 this가 뭐임..>??????
		...
		for(int i=0; i<jbtns_label.length;i++) {
			...
			jbtns[i].addActionListener(smEvent);//this는 현재 활성화된 객체 주소번지 SaralyMgr
		}///////////////////////end of for
		initDisplay();
	}//////////////////////////end of SalaryMgrView생성자
