...
public class ApiExamCaptchaImage {
	public ApiExamCaptchaImage(String key) {
		...
		String clientId = "MR4KUZCzdMb3jrlBQiKf"; //애플리케이션 클라이언트 아이디값";
        String clientSecret = "RadXAcjg5M"; //애플리케이션 클라이언트 시크릿값";
 ...
 public static void main(String[] args) {
     ...
     String key = "gtQfimWqQk4pnAav"; // https://openapi.naver.com/v1/captcha/nkey 호출로 받은 키값
