...
public class LoginView extends Object implements ActionListener{ //인터페이스 이다. 결합도를 낮추는 코드를 작성할 때 필요함 - 클래스 설계씨 필요함. 복습을 할 필요가 없는 이유는 요즘은 웹기반으로 처리를 하니까...
	...
	public void initDisplay() {
		...
		jf.setSize(500, 400);
		jf.setVisible(true); //true이면 화면에 보여줄게, false면 비활성화 해줄게
	}
